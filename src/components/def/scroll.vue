...
<script type="text/ecmascript-6">
	import BScroll from '../common/scroll/index';
	import Bubble from '../common/scroll/bubble.vue';
		...
		methods: {
			initScroll() {
				...
				if (this.$refs.listWrapper && (this.pullDownRefresh || this.pullUpLoad)) {
					this.$refs.listWrapper.style.minHeight = `${util.getRect(this.$refs.wrapper).height + 1}px`;
				}
