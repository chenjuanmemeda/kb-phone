<template>
    <div :class="[prefixCls]">
        <div
            ...
            <form id="form" @change="handleChange">
                <input
                        id="uploadControl"
                        style="display: none"
                        ref="input"
...
<script>
	...
	import {bindEvent, unBindEvent} from "./Android_event";
	...
	export default {
		...
		methods: {
			...
			post(file) {
				...
				// 	let dataURL = '';
				// 	dataURL = windowURL.createObjectURL(file); // 处理过后的图片
				// 	console.log(dataURL);
				// 	this.handleSuccess({
				// 		code: 200,
				// 		msg: '操作成功',
				...
				// ajax 提交到图片站点 ：/api/anon/common/upload.do
				ajax({
